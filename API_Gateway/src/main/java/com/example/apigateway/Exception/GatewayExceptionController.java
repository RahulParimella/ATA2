...
//
//@ControllerAdvice
//public class GatewayExceptionController extends ResponseEntityExceptionHandler{
////
...
//	public ResponseEntity<GatewayException> handleGlobalException(Exception exception, WebRequest webRequest) {
//		GatewayException errorDetails = new GatewayException(new Date(), exception.getMessage(),
